...
DBT_CREDITGENIE_APP_DIR = os.path.join(DBT_MODEL_DIR, "creditgenie_app")
...
dag = DAG(
    "creditgenie_app_daily_transforms",
...
with open(os.path.join(config_dir, "creditgenie_app_transforms.yml")) as etl_file:
