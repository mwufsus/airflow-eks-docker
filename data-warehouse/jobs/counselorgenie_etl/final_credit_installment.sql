create table if not exists dimensions_counselorgenie.f_credit_installment (
    credit_installment_id varchar(64) PRIMARY KEY,
...
TRUNCATE TABLE dimensions_counselorgenie.f_credit_installment;

SET
    enable_case_sensitive_identifier to TRUE;

INSERT INTO
    dimensions_counselorgenie.f_credit_installment
SELECT
...
WHERE
    ...
    AND rdata."portfolioType" :: varchar(64) = 'installment';