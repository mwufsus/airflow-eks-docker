create table if not exists dimensions_counselorgenie.f_counselorgenie_debt (
...
TRUNCATE TABLE dimensions_counselorgenie.f_counselorgenie_debt;

SET
    enable_case_sensitive_identifier to TRUE;

INSERT INTO
    dimensions_counselorgenie.f_counselorgenie_debt
SELECT
    rdata."id" :: varchar(64) as debt_id,
