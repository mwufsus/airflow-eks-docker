create table if not exists dimensions_counselorgenie.f_credit_open (
    credit_open_id VARCHAR(64) PRIMARY KEY,
...
TRUNCATE TABLE dimensions_counselorgenie.f_credit_open;

SET
    enable_case_sensitive_identifier to TRUE;

INSERT INTO
    dimensions_counselorgenie.f_credit_open
SELECT
...
WHERE
    ...
    AND rdata."portfolioType" :: varchar(64) = 'open';